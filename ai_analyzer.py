...
{cats}
性别信号优先：先扫标题/标签里的受众性别信号。出现 남자、남성、맨즈、#남자코디、#남성패션、boy、men 等明显男性信号时，禁止选「여성 의류」，应选「남성 의류」；反之出现 여자、여성、걸、#여자코디 等明显女性信号时，禁止选「남성 의류」。鞋、墨镜、帽子、腰带、包等穿搭单品，按受众性别归入对应服装类；性别不明时选「의복 & 부속품」。
