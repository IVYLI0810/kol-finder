...
# 每个垂类的"说明书"：告诉AI什么内容的博主归这类（含代表性二级/三级类目）
# 这是解决"AI判不准"的核心——以前只给类目名不给说明，AI只能靠猜
CATEGORY_GUIDE = {
    "여성 의류": "女装穿搭、女性时尚、ootd、通勤穿搭、连衣裙/上衣/外套/泳装等女性服饰展示、试穿、搭配类博主",
    "남성 의류": "男装穿搭、男性时尚、男士服饰展示与搭配类博主",
    "뷰티 & 헬스": "护肤、彩妆、香水、美容仪器、美甲、美发造型、按摩放松、个护、脱毛等美妆健康类内容博主",
    "홈 & 가든": "独居日常、房间布置、收纳整理、家居装饰、家纺、厨房餐厅、园艺、节日派对布置、清洁好物等家居生活类博主",
    "반려동물 용품": "猫、狗、小宠、水族、爬宠等宠物日常、宠物用品开箱测评类博主",
    "완구 & 게임": "玩具开箱、积木拼搭、盲盒收藏、桌游、遥控玩具、娃娃、手工DIY玩具等玩具游戏类博主",
    "식품 & 장보기": "一人食、料理做饭、零食测评、烘焙、食材开箱、食品杂货购物分享类博主",
    "스포츠 & 아웃도어": "健身、骑行、露营徒步、滑板轮滑、滑雪、团队运动、运动穿搭等运动户外类博主",
    "휴대폰 & 액세서리": "手机壳、充电器、耳机、手机摄影配件、手机评测、手机周边好物类博主",
    "전자제품": "数码产品、便携音视频、VR/AR、智能穿戴、电子元器件、DIY电子制作等电子产品类博主",
    "가전제품": "厨房电器、清洁电器、个护电器、生活小家电等家电开箱测评类博主",
    "주얼리 & 액세서리": "首饰、项链、耳环、戒指、手链、手表、饰品搭配等珠宝饰品类博主",
    "가방 & 캐리어": "包包、行李箱、背包、通勤包、斜挎包等箱包展示搭配类博主",
    "신발": "鞋子穿搭、运动鞋、女鞋男鞋、鞋类护理等鞋类内容博主",
    "유아 & 출산": "母婴、育儿、婴儿服装、喂养、婴童鞋、孕产、童装等母婴类博主",
    "가구": "客厅/卧室/办公/儿童/户外家具等家具选购、布置、测评类博主",
    "공구 & 홈인테리어": "工具、五金、家装、灯具照明、智能家居、电气管道等家装维修改造类博主",
    "자동차 부품": "汽车电子、车灯、内饰配件、汽车养护、行车记录仪、车载好物等汽车用品类博主",
    "오토바이 & 파워스포츠": "摩托车、骑行装备、动力运动、船艇等摩托/动力运动类博主",
    "사무 & 학용품": "文具、办公用品、学习用品、桌面收纳、手账、绘画材料、study with me等办公学习类博主",
    "공예 & 재봉": "手工艺、缝纫、编织、纸艺、绘画、雕塑翻模等手工创作类博主",
    "헤어 익스텐션 & 가발": "假发、接发、编发、发型变换等假发造型类博主",
    "서적 & 미디어": "读书、书单推荐、音乐、影视、IP周边、文创等图书音像类博主",
    "특수 의류 & 코스프레": "角色扮演、演出服、情趣内衣、工装制服、传统民族服饰等特殊服饰类博主",
    "산업 & 과학": "工业设备、自动化、包装印刷、机械、原材料等工商业科学类内容博主（罕见）",
    "기타": "以上类目都不沾边（如纯游戏、新闻、政治、体育赛事解说、纯搞笑、音乐翻唱、猎奇、情感、教育科普等非带货向内容）",
}
...
def _build_prompt(briefs: list[dict]) -> str:
    ...
    cat_guide = "\n".join(f"- {c}：{CATEGORY_GUIDE.get(c, '')}" for c in AI_CATEGORY_TABLE)
...
1. category：这个频道的内容最适合挂哪类商品的链接。必须从下面26个类目里选一个，一字不差地写：
{cats}
...
判类规则：
- 以频道的主要/近期内容为准，不要只看频道名
- 一个频道沾多个类目时，选内容占比最大、最适合挂商品链接的那个
- 都不沾边（如纯游戏、新闻、政治、体育解说、纯搞笑、音乐翻唱、猎奇等）→ 选「기타」，不要硬塞进其他类目
